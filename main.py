...
####
# CHANGELOG:
# Adjusted screen width and height of canvas
# Added Flag rules
# Visualized obstacles created button to turn on/off
# created slider that adjusted the BOID_SPEED without rerunning
# Removed black outline
# Commented out the canvas.delete in update function to create a drawing effect
# changed boid colors
####
# -*- coding: utf-8 -*-
"""
...
class Flocking(tk.Tk):
    ...
    '''
    def __init__(self, *args, **kwargs):
        # pop removes width and height kwargs before passing to TK__init__
